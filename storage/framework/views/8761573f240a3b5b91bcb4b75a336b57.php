<head>
    ...
    <!-- Linear Icon css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/linearicon.css')); ?>">

    <!-- fontawesome css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/font-awesome.css')); ?>">

    <!-- Themify icon css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/themify.css')); ?>">

    <!-- ratio css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/ratio.css')); ?>">

    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/remixicon.css')); ?>">

    <!-- Feather icon css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/feather-icon.css')); ?>">

    <!-- Plugins css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/scrollbar.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/animate.css')); ?>">

    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vendors/bootstrap.css')); ?>">

    <!-- vector map css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/vector-map.css')); ?>">

    <!-- Slick Slider Css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/vendors/slick.css')); ?>">

    <!-- App css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/style.css')); ?> ">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/customeCss.css')); ?> ">

    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
</head><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/layouts/head.blade.php ENDPATH**/ ?>