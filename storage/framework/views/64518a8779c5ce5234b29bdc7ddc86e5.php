...
<head>
    ...
    <title><?php echo e($loginTitle ?? 'Ecommerce Login'); ?></title>
    <?php echo $__env->make('layouts.favicon-dynamic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo e(asset('public/assets/css/customeCss.css')); ?>" rel="stylesheet">
    ...
    <div class="row m-0 w-100">
        ...
        <div class="col-md-6">
            <div class="login-container">
                ...
                <div class="subtitle"><?php echo e($loginTitle ?? 'Admin Login'); ?></div>
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" id="checkLoginForm"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="extra-links">
                        <a href="<?php echo e(route('forgot.password')); ?>"><i class="ri-lock-password-line"></i> Forgot
                            Password?</a>
...
</html><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/auth/login.blade.php ENDPATH**/ ?>