                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-header-2">
                                            <h5><?php echo e($title ?? 'Add Sub Category'); ?></h5>
                                        </div>
                                        ...
                                        <?php endif; ?>
                                        <form action="<?php echo e(route('admin.store-sub-category')); ?>" method="POST" enctype="multipart/form-data" id="subCategoryForm">
                                            <?php echo csrf_field(); ?>
                                            <div class="theme-form theme-form-2 mega-form">
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" id="sub_category_name" type="text" name="sub_category_name" placeholder="Sub Category Name" value="<?php echo e(old('sub_category_name')); ?>">
                                                ...
                                                <div class="mb-4 row align-items-center mt-5">
                                                    ...
                                                    <div class="form-group col-sm-9">
                                                        <div class="input-group">
                                                            <textarea class="form-control" id="sub_category_description" name="sub_category_description" placeholder="Sub Category Description"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/categories/addSubCategory.blade.php ENDPATH**/ ?>