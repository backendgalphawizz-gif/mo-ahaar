                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-header-2">
                                            <h5><?php echo e($title ?? 'Add Order'); ?></h5>
                                        </div>
                                        ...
                                        <form action="<?php echo e(route('admin.store-order')); ?>" method="POST" id="orderForm">
                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" id="payment_method" name="payment_method">
                                                            ...
                                                            <?php $__empty_1 = true; $__currentLoopData = ($activePaymentMethods ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <option value="<?php echo e($method->gateway); ?>" <?php echo e(old('payment_method') == $method->gateway ? 'selected' : ''); ?>>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select class="form-select" id="order_status" name="order_status">
                                                            <?php $__currentLoopData = $addStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($val); ?>" <?php if($osAdd === $val): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control amount-input" id="subtotal" type="number" step="0.01" min="0" name="subtotal" value="<?php echo e(old('subtotal', '0')); ?>">
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control amount-input" id="tax_amount" type="number" step="0.01" min="0" name="tax_amount" value="<?php echo e(old('tax_amount', '0')); ?>">
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control amount-input" id="shipping_amount" type="number" step="0.01" min="0" name="shipping_amount" value="<?php echo e(old('shipping_amount', '0')); ?>">
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" id="total_amount" type="number" step="0.01" min="0" name="total_amount" value="<?php echo e(old('total_amount', '0')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="shipping_address" name="shipping_address" rows="3" placeholder="Shipping Address"><?php echo e(old('shipping_address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?></p>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Order Notes"><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/orders/addOrder.blade.php ENDPATH**/ ?>