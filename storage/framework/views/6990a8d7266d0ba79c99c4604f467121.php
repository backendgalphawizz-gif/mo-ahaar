        ...
        <div class="container-fluid">
            ...
            <div class="web-settings-shell">
                <div class="web-settings-hero">
                    <div>
                        <h5 class="web-settings-title"><i class="ri-settings-3-line me-2"></i><?php echo e($title); ?></h5>
            ...
            <div class="card settings-main-card">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.settings.store.update')); ?>" enctype="multipart/form-data"
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('site_title', $setting->site_title ?? '')); ?>" minlength="2"
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('app_name', $setting->app_name ?? '')); ?>" minlength="2"
                                        maxlength="150" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="support_number" id="support_number"
                                        class="form-control <?php $__errorArgs = ['support_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('support_number', $setting->support_number ?? '')); ?>"
                                        inputmode="numeric" pattern="[0-9]{10}" minlength="10" maxlength="10" required>
                                    <?php $__errorArgs = ['support_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="support_email"
                                        class="form-control <?php $__errorArgs = ['support_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('support_email', $setting->support_email ?? '')); ?>" maxlength="150"
                                        required>
...
unset($__errorArgs, $__bag); ?>" minlength="5"
                                        maxlength="1000" required><?php echo e(old('address', $setting->address ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    <?php if(!empty($setting->logo)): ?>
                                        <div class="upload-preview-box">
                                            ...
                                            <img src="<?php echo e(asset('public/uploads/settings/' . $setting->logo)); ?>" alt="logo"
...
unset($__errorArgs, $__bag); ?>
                                    <?php if(!empty($setting->favicon)): ?>
                                        <div class="upload-preview-box">
                                            ...
                                            <img src="<?php echo e(asset('public/uploads/settings/' . $setting->favicon)); ?>" alt="favicon"
                        ...
                        <?php if(\Illuminate\Support\Facades\Schema::hasColumn('store_settings', 'customer_home_sliders_enabled')): ?>
                            <div class="col-12 settings-section">
                                <div class="section-head">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_home_sliders_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_home_sliders_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_home_sliders_enabled', (int) ($setting?->customer_home_sliders_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>
                                                Show</option>
                                            <option value="0" <?php echo e(old('customer_home_sliders_enabled', (int) ($setting?->customer_home_sliders_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>
                                                Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_home_sliders_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_home_offers_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_home_offers_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_home_offers_enabled', (int) ($setting?->customer_home_offers_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>
                                                Show</option>
                                            <option value="0" <?php echo e(old('customer_home_offers_enabled', (int) ($setting?->customer_home_offers_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>
                                                Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_home_offers_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_home_promotions_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_home_promotions_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_home_promotions_enabled', (int) ($setting?->customer_home_promotions_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_home_promotions_enabled', (int) ($setting?->customer_home_promotions_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_home_promotions_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_home_announcements_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_home_announcements_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_home_announcements_enabled', (int) ($setting?->customer_home_announcements_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_home_announcements_enabled', (int) ($setting?->customer_home_announcements_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_home_announcements_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_home_featured_products_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_home_featured_products_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_home_featured_products_enabled', (int) ($setting?->customer_home_featured_products_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_home_featured_products_enabled', (int) ($setting?->customer_home_featured_products_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_home_featured_products_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(\Illuminate\Support\Facades\Schema::hasColumn('store_settings', 'customer_registration_privacy_policy_enabled')): ?>
                            <div class="col-12 settings-section">
                                <div class="section-head">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_registration_privacy_policy_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_registration_privacy_policy_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_registration_privacy_policy_enabled', (int) ($setting?->customer_registration_privacy_policy_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_registration_privacy_policy_enabled', (int) ($setting?->customer_registration_privacy_policy_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_registration_privacy_policy_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_registration_terms_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_registration_terms_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_registration_terms_enabled', (int) ($setting?->customer_registration_terms_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_registration_terms_enabled', (int) ($setting?->customer_registration_terms_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_registration_terms_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select name="customer_registration_faq_enabled"
                                            class="form-select <?php $__errorArgs = ['customer_registration_faq_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value="1" <?php echo e(old('customer_registration_faq_enabled', (int) ($setting?->customer_registration_faq_enabled ?? 1)) === 1 ? 'selected' : ''); ?>>Show</option>
                                            <option value="0" <?php echo e(old('customer_registration_faq_enabled', (int) ($setting?->customer_registration_faq_enabled ?? 1)) === 0 ? 'selected' : ''); ?>>Hide</option>
                                        </select>
                                        <?php $__errorArgs = ['customer_registration_faq_enabled'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/settings/store.blade.php ENDPATH**/ ?>