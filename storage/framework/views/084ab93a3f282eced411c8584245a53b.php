                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                ...
                                <div class="user-name-hide media-body">
                                    ...
                                    <p class="mb-0 font-roboto"><?php echo e($isVendorPanel ? 'Vendor' : 'Admin'); ?><i class="middle ri-arrow-down-s-line"></i></p>
                                </div>
                            </div>
                            <ul class="profile-dropdown onhover-show-div">
                                ...
                                <?php endif; ?>
                                <li>
                                    <a href="<?php echo e(route($isVendorPanel ? 'vendor.orders' : 'admin.orders')); ?>">
                                ...
                                <?php endif; ?>
                                <li>
                                    <a href="<?php echo e(route($isVendorPanel ? 'vendor.dashboard' : 'admin.profile.edit')); ?>">
                                        <i data-feather="settings"></i>
                                        <span><?php echo e($isVendorPanel ? 'Dashboard' : 'Settings'); ?></span>
                                    </a>
                                </li>
                                <li>
...
</html><?php /**PATH C:\xampp\htdocs\Projects\mo-ahaar\resources\views/layouts/app.blade.php ENDPATH**/ ?>