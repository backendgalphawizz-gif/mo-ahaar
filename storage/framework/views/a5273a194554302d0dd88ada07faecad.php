...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.partials.dashboard-ui', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php
        $dashboardLinks = [
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="kpi-card kpi-vendors">
                        ...
                        <p>Total Vendors</p>
                        <h3><?php echo e(number_format((int) ($totalVendors ?? 0))); ?></h3>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="kpi-card kpi-revenue">
                        ...
                        <p>Revenue</p>
                        <h3>₹<?php echo e(number_format((float) ($totalRevenue ?? 0), 0)); ?></h3>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="kpi-card kpi-active-vendors">
                        ...
                        <p>Active Vendors</p>
                        <h3><?php echo e(number_format((int) ($activeVendors ?? 0))); ?></h3>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="kpi-card kpi-active-users">
                        ...
                        <p>Active Users</p>
                        <h3><?php echo e(number_format((int) ($activeUsers ?? 0))); ?></h3>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="kpi-card kpi-pending">
                        ...
                        <h3><?php echo e(number_format((int) ($pendingApprovals ?? 0))); ?></h3>
                    </div>
                </div>
            </div>
...
.chart-panel-lg { height: 320px; min-height: 320px; }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var salesLabels = <?php echo json_encode($salesChartLabels ?? [], 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\mo-ahaar\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>