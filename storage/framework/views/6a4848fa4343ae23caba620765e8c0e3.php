...
<div class="page-body">
    <div class="container-fluid">
        <div class="title-header option-title d-flex align-items-center flex-wrap gap-2 mb-4">
            ...
            <a class="btn btn-outline-secondary btn-sm ms-auto" href="<?php echo e(route('admin.products', array_filter(['segment' => $segment ?? null]))); ?>">
                <i class="ri-arrow-left-line me-1"></i>Back to products
            </a>
            <a class="btn btn-theme btn-sm" href="<?php echo e(route('admin.view-product', $product->product_id)); ?>">
        ...
        <form method="POST" action="<?php echo e(route('admin.update-product')); ?>" enctype="multipart/form-data" id="productForm">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="product_id" value="<?php echo e($product->product_id); ?>">
                <input type="hidden" name="is_active_status" value="<?php echo e($product->is_active_status); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Product name" value="<?php echo e(old('product_name', $product->product_name)); ?>" maxlength="100" data-product-name required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="target_user_type" id="target_user_type" class="form-select <?php $__errorArgs = ['target_user_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="<?php echo e(\App\Models\Product::TARGET_RETAILER); ?>" <?php echo e((string) old('target_user_type', $product->target_user_type) === \App\Models\Product::TARGET_RETAILER ? 'selected' : ''); ?>>Retailer</option>
                                        <option value="<?php echo e(\App\Models\Product::TARGET_WHOLESALER); ?>" <?php echo e((string) old('target_user_type', $product->target_user_type) === \App\Models\Product::TARGET_WHOLESALER ? 'selected' : ''); ?>>Wholesaler</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" <?php echo e(old('featured', $product->featured) == 1 ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="category_id" id="category_id" required>
                                        ...
                                        <?php $__currentLoopData = $categoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->category_id); ?>" <?php echo e((string) old('category_id', $product->category_id) === (string) $category->category_id ? 'selected' : ''); ?>><?php echo e($category->category_name); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="sub_category_id" id="sub_category_id" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="url" name="video" class="form-control <?php $__errorArgs = ['video'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="https://www.youtube.com/watch?v=..." value="<?php echo e(old('video', $product->video)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="product_description" id="product_description" rows="5" maxlength="220" class="form-control <?php $__errorArgs = ['product_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Full description" required><?php echo e(old('product_description', $product->product_description)); ?></textarea>
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        <small class="text-muted"><i class="ri-information-line me-1"></i>Maximum 220 characters allowed.</small>
                                        <small id="desc_counter" class="text-muted"><span id="desc_count"><?php echo e(strlen(old('product_description', $product->product_description ?? ''))); ?></span> / 220</small>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="mrp_price" id="mrp_price" class="form-control <?php $__errorArgs = ['mrp_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="0.00" value="<?php echo e(old('mrp_price', $product->mrp_price ?? $product->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" name="discount" id="discount_pct" class="form-control <?php $__errorArgs = ['discount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="0.00" value="<?php echo e($discountPct); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" id="price_display" class="form-control bg-light text-dark" placeholder="0.00" value="<?php echo e(old('price', $product->price)); ?>" readonly tabindex="-1">
                                    <input type="hidden" name="price" id="price" value="<?php echo e(old('price', $product->price)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" min="0" name="stock" id="product_stock" class="form-control <?php $__errorArgs = ['stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="0" value="<?php echo e(old('stock', $product->stock)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="stock_status" class="form-select <?php $__errorArgs = ['stock_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="backorder" <?php echo e(old('stock_status', $product->stock_status) === 'backorder' ? 'selected' : ''); ?>>On backorder</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 <?php echo e((string) old('target_user_type', $product->target_user_type) === \App\Models\Product::TARGET_WHOLESALER ? '' : 'd-none'); ?>" id="wholesalerMinQtyWrap">
                                    <label class="form-label-title">Start Order Quantity <span class="text-danger">*</span></label>
                                    <input type="number" min="1" name="min_quantity" id="min_quantity" class="form-control <?php $__errorArgs = ['min_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. 6" value="<?php echo e(old('min_quantity', $product->min_quantity)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="sku" maxlength="100" class="form-control <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Leave blank to auto-generate" value="<?php echo e(old('sku', $product->sku)); ?>">
                                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="gst_calculation_type" class="form-select <?php $__errorArgs = ['gst_calculation_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="excluded" <?php echo e(old('gst_calculation_type', $product->gst_calculation_type ?? \App\Models\Product::GST_EXCLUDED) === \App\Models\Product::GST_EXCLUDED ? 'selected' : ''); ?>>Excluded GST</option>
                                        <option value="included" <?php echo e(old('gst_calculation_type', $product->gst_calculation_type ?? \App\Models\Product::GST_EXCLUDED) === \App\Models\Product::GST_INCLUDED ? 'selected' : ''); ?>>Included GST</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="gst_tax_id" class="form-select <?php $__errorArgs = ['gst_tax_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $gstTaxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($gst->id); ?>" <?php echo e((string) old('gst_tax_id') !== '' ? (string) old('gst_tax_id') === (string) $gst->id ? 'selected' : '' : (number_format((float) $gst->percentage, 2) === number_format((float) $product->gst_percentage, 2) ? 'selected' : '')); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <option value="1" <?php echo e((string) old('status', $product->status) === '1' ? 'selected' : ''); ?>>Approved</option>
                                        <option value="2" <?php echo e((string) old('status', $product->status) === '2' ? 'selected' : ''); ?>>Pending</option>
                                        <option value="3" <?php echo e((string) old('status', $product->status) === '3' ? 'selected' : ''); ?>>Rejected</option>
                                    </select>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" name="product_image" id="product_image" class="d-none <?php $__errorArgs = ['product_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" accept="image/*">
                                <label for="product_image" id="thumbDropZone" class="img-dropzone <?php $__errorArgs = ['product_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                    <div class="dropzone-placeholder" id="thumbPlaceholder" <?php if(!empty($product->product_image)): ?> style="display:none" <?php endif; ?>>
                                    ...
                                    <div id="thumbPreview" class="dropzone-preview <?php if(empty($product->product_image)): ?> d-none <?php endif; ?>">
                                        <?php if(!empty($product->product_image)): ?>
                                            <img id="thumbPreviewImg" src="<?php echo e(asset('public/uploads/products/' . $product->product_image)); ?>" alt="Current thumbnail">
                                        <?php else: ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-danger small mt-2 mb-0"><i class="ri-error-warning-line me-1"></i><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php if(!empty($product->gallery_images)): ?>
                                    <div class="gallery-preview-grid mb-3" id="currentGalleryImages">
                                        <?php $__currentLoopData = array_filter(array_map('trim', explode(',', $product->gallery_images))); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="gallery-thumb" id="gthumb-<?php echo e(md5($gimg)); ?>">
                                                <img src="<?php echo e(asset('public/uploads/products/' . $gimg)); ?>" alt="">
                                                <button type="button" class="gallery-thumb-remove" data-image="<?php echo e($gimg); ?>" onclick="markImageForDelete(this, event)" title="Remove">
                                ...
                                <input type="file" name="gallery_images[]" id="gallery_images" class="d-none <?php $__errorArgs = ['gallery_images'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" accept="image/*" multiple>
                                <label for="gallery_images" id="galleryDropZone" class="img-dropzone img-dropzone--sm <?php $__errorArgs = ['gallery_images'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> has-error <?php unset($message);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var initialSubCategoryId = <?php echo json_encode(old('sub_category_id', $product->sub_category_id)); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/products/editProduct.blade.php ENDPATH**/ ?>