        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="card border-0 customer-stat customer-stat-teal h-100">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div class="stat-content">
                                        ...
                                        <h3 class="stat-value"><?php echo e($totalCustomers); ?></h3>
                                    </div>
                                ...
                                <div class="card border-0 customer-stat customer-stat-rose h-100">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div class="stat-content">
                                            ...
                                            <h3 class="stat-value"><?php echo e($rejectedCount); ?></h3>
                                        </div>
                                        <span class="stat-icon-box">
                    ...
                    <form method="GET" action="<?php echo e(route('admin.customers')); ?>" class="customer-filter-toolbar mb-3">
                        <div class="customer-filter-grid">
                            <div class="customer-filter-field customer-filter-search d-flex align-items-center gap-2">
                                ...
                                <input type="text" name="search" id="searchText" class="form-control"
                                    value="<?php echo e($search ?? ''); ?>" placeholder="Search by name, email or mobile">
                            ...
                            <div class="customer-filter-actions">
                                <a href="<?php echo e(route('admin.customers')); ?>" class="btn btn-outline-secondary">Reset</a>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('admin.customers.export-excel', array_filter(['search' => $search ?? '']))); ?>">
                                                <i class="ri-file-excel-line me-1 text-success"></i> Export Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('admin.customers.export-pdf', array_filter(['search' => $search ?? '']))); ?>">
                    ...
                    <div class="card card-table">
                        <div class="card-body">
                                ...
                                <table class="table table table-modern align-middle" id="table_id">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $allCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td><?php echo e(($allCustomers->firstItem() ?? 0) + $loop->index); ?></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="table-image" style="float:none;">
                                                            <img src="<?php echo e(!empty($customer->profile_image) ? asset('public/uploads/customers/' . $customer->profile_image) : asset('public/uploads/customers/customer.png')); ?>"
                                                                class="img-fluid" alt="<?php echo e($customer->name); ?>">
                                                        </div>
                                                        <div class="user-name">
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif(strcasecmp($segment, 'Wholesaler') === 0): ?>
                                                        <span
                                                            class="badge bg-primary-subtle text-primary border border-primary-subtle">Wholesaler</span>
                                                    <?php elseif(strcasecmp($segment, 'Retailer') === 0): ?>
                                                        <span
                                                            class="badge bg-success-subtle text-success  border-success-subtle">Retailer</span>
                                                    <?php else: ?>
                                                        <span
                                                            class="badge bg-secondary-subtle text-secondary border border-secondary-subtle"><?php echo e($segment); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <?php if($isRetailerRow || $gst === ''): ?>
                                                        <span class="text-muted">—</span>
                                                    <?php elseif($gstOk): ?>
                                                        <span
                                                            class="badge bg-success-subtle text-success border border-success-subtle"
                                                            title="Verified at <?php echo e(\Carbon\Carbon::parse($customer->gst_verified_at ?? null)->format('d M Y H:i')); ?>">Verified</span>
                                                    <?php else: ?>
                                                        <span
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    ?>
                                                    <?php if(!empty($hasApproval) && $apRow !== 'approved'): ?>
                                                        <?php if($apRow === 'pending'): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <form method="POST"
                                                            ...
                                                            <label class="status-switch" title="Activate / deactivate account">
                                                                <input type="checkbox" aria-label="Toggle customer account" <?php echo e($isCustomerActive ? 'checked' : ''); ?>
                                                ...
                                                <td>
                                                    <ul class="d-flex gap-2 mb-0 list-unstyled align-items-center">
                                                        <li>
                                                            <a href="<?php echo e(route('admin.view-customer', urlencode(Crypt::encrypt($customer->customer_id)))); ?>"
                                                                title="View profile">
                                                        ...
                                                        <?php if(!empty($hasApproval) && $apRow === 'pending'): ?>
                                                            <li>
                                                                <form method="POST"
                                                            ...
                                                            <li>
                                                                <button type="button" class="btn btn-link p-0 text-danger border-0"
                                                                    ...
                                                                    data-customer-id="<?php echo e($customer->customer_id); ?>"
                                                        ...
                                                        ?>
                                                        <?php if($canVerifyGst && !empty($hasGstVerified)): ?>
                                                            <li>
                                                                <form method="POST"
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" title="Delete"
                                                                data-customer-id="<?php echo e(urlencode(Crypt::encrypt($customer->customer_id))); ?>"
                                                                data-customer-name="<?php echo e($customer->name); ?>"
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td colspan="<?php echo e(!empty($hasApproval) ? 10 : 9); ?>"
                            ...
                            <?php if($allCustomers->hasPages()): ?>
                                <div
                                    class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 mt-3 admin-pagination-wrap">
                                    <div class="text-muted small">
                                        Showing <?php echo e($allCustomers->firstItem()); ?> to <?php echo e($allCustomers->lastItem()); ?> of
                                        <?php echo e($allCustomers->total()); ?> entries
                                    </div>
                                    <div>
                                        <?php echo e($allCustomers->onEachSide(1)->links('pagination::bootstrap-5')); ?>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (rejectModal) {
                rejectModal.addEventListener('show.bs.modal', function (event) {
                    ...
                    var base = <?php echo json_encode(rtrim(url('/admin/customers'), '/'), 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/customers/customersList.blade.php ENDPATH**/ ?>