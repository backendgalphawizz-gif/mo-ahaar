...
<div class="page-body">
    <div class="container-fluid">
        <div class="title-header option-title d-flex align-items-center mb-4">
            <h5><i class="ri-edit-line me-2"></i><?php echo e($title); ?></h5>
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.banners.update', $banner->id)); ?>" enctype="multipart/form-data" class="row g-3">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $banner->title)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('link', $banner->button_link)); ?>" placeholder="https://example.com/page">
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = \App\Models\Banner::homeBannerTypeOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($opt); ?>" <?php echo e($currentType === $opt ? 'selected' : ''); ?>><?php echo e($typeLabels[$opt] ?? $opt); ?></option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('visible_from', optional($banner->visible_from)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('visible_to', optional($banner->visible_to)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="1" <?php echo e((string) old('status', $banner->status) === '1' ? 'selected' : ''); ?>>Active</option>
                            <option value="2" <?php echo e((string) old('status', $banner->status) === '2' ? 'selected' : ''); ?>>Inactive</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <img src="<?php echo e(asset('public/uploads/banners/' . $banner->banner_image)); ?>" alt="banner" style="width:180px;height:90px;object-fit:cover;border-radius:8px;">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developmentalpha/public_html/swastik-food-machinery.developmentalphawizz.com/resources/views/admin/banners/edit.blade.php ENDPATH**/ ?>