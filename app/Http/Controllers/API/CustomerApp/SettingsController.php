...
{
    /**
     * GET /api/customer-app/settings/business
     * Privacy policy, terms & conditions, and FAQs for profile / support screens.
     */
     ...
     */
    private function customerBusinessPageVisibility(): array
    {
        $defaults = [
            'privacy_policy' => true,
