...
<head>
    ...
    <title>{{ $pageTitle ?? 'Verify OTP - E-Commerce Admin' }}</title>
    ...
    <div class="row m-0 w-100">
        ...
        <div class="col-md-6">
            <div class="reset-container">
                ...
                <div class="subtitle">{{ $subtitle ?? 'Verify OTP' }}</div>
                ...
                <div class="email-display">
                    <i class="ri-mail-line"></i> Verification code sent to: <strong>{{ $email }}</strong>
                </div>

                <form action="{{ route($verifyOtpRoute ?? 'verify.otp') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="otp" placeholder="000000" maxlength="6"
                            pattern="[0-9]{6}" required autofocus value="{{ old('otp') }}">
                        @error('otp')
                ...
                <div class="resend-link">
                    <form action="{{ route($resendOtpRoute ?? 'resend.otp') }}" method="POST" style="display: inline;">
                        @csrf
