<!-- Modal End -->
    ...
    <script src="{{ asset('public/assets/js/custom-slick.js') }}"></script>

    <!-- customizer js -->
    <script src="{{ asset('public/assets/js/customizer.js') }}"></script>

    <!-- ratio js -->
    <script src="{{ asset('public/assets/js/ratio.js') }}"></script>

    <!-- sidebar effect -->
    <script src="{{ asset('public/assets/js/sidebareffect.js') }}"></script>
